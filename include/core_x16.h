...
#define CX16_KEY_MOD_LOGO    8  // logo keys
...
/*
typedef struct {	
	unsigned char eighteen_min_count;  // 1083.75 seconds   276356.25 seconds total  ,  4605.9375 minutes -->  76.77 hrs
	unsigned char four_quater_count;
	unsigned char jiffies;  // 60 times a second... 0 to 255 = 4.25 seconds.
} CX16_clock_type;
...
void cx16_update_clock()
{
  ...
  __asm__("STY %v", reg_y);  
	...
	cx16_clock.four_quater_count = reg_x;
	cx16_clock.eighteen_min_count = reg_y;  	
}
*/
